...
//     }
//   };
//   return <section id="contact" className="py-20 bg-gradient-to-br from-blue-50 to-purple-50 w-full">
//       <div className="container mx-auto px-6">
//         <motion.div ref={ref} initial="hidden" animate={inView ? 'show' : 'hidden'} variants={containerVariants} className="text-center mb-16">
//           <motion.h2 variants={itemVariants} className="text-3xl md:text-4xl font-bold mb-4 bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
//             Get In Touch
//           </motion.h2>
...
//           </motion.div>
//           <motion.div variants={containerVariants} initial="hidden" animate={inView ? 'show' : 'hidden'}>
//             <motion.form variants={itemVariants} className="bg-white rounded-xl p-8 shadow-md" onSubmit={e => e.preventDefault()}>
//               <h3 className="text-2xl font-bold mb-6">Send a Message</h3>
//               <div className="space-y-4">
//                 <div>
//                   <label htmlFor="name" className="block text-sm font-medium text-gray-700 mb-1">
